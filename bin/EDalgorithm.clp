...
(defrule ED-risk-status-Bulimia-symptoms
 ...
 (bind ?*analysis* (call "==> Patient is showing signs of having Bulimia"))
...
(defrule ED-risk-status-No-Signs
 ...
 (recommend-action ?*analysis* )) 
;; (bind ?*analysis* "
;;     RISK ANALYSIS ::=>  Patient is not showing any signs of having any Eating Disorder!")
;;(recommend-action ?*analysis* ))
...
(defrule check-time-value
  ...
  (test (or (>= (integer ?*eat_time*) 72) (<=(integer ?*eat_time*) 52)))
...
;; Main window
(defglobal ?*frame* = (new JFrame "ED RISK ANALYZER"))
...
(defglobal ?*acombo-ok* = (new JButton <==Selected-Correct!))
